...
base_url = "https://rahulshettyacademy.com"     #Базовый URL для всех запросв
...
class Google_maps_api():
    ...
    def create_new_place():
        ...
        post_resouse = "/maps/api/place/add/json"       # Ресурс метода POST
        ...
        post_url = base_url + post_resouse + key
        print(post_url)
    ...
    """Метод для роверки новой локации"""
    @staticmethod
